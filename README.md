...
| --- | --- | --- |
| [Mac app](https://github.com/jniedzie/brainselector/releases/download/v0.6.2/BrainSelector-0.6.2-macOS-arm64.zip) | ChatGPT desktop app with a menu-bar dashboard | Apple Silicon, macOS 15 or later |
